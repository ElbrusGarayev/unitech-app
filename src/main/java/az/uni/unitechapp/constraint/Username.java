...
@NotBlank(message = HttpRequestValidationMessageKeyConstants.USERNAME_CAN_NOT_BE_NULL)
@Pattern(regexp = HttpRequestValidationRegexConstants.PIN, message = HttpRequestValidationMessageKeyConstants.PIN_NOT_VALID)
public @interface Username {
     ...
     */
    String message() default HttpRequestValidationMessageKeyConstants.PIN_NOT_VALID;
